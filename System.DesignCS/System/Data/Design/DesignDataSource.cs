namespace System.Data.Design
{
    ...
    internal class DesignDataSource : DataSourceComponent, IDataSourceNamedObject, INamedObject, IDataSourceCommandTarget
    {
        ...
        [DataSourceXmlSubItem(Name="Connections", ItemType=typeof(DesignConnection)), Browsable(false), DisplayName("Connections")]
        ...
        [DataSourceXmlSubItem(Name="Tables", ItemType=typeof(DesignConnection)), Browsable(false)]
        ...
        [DefaultValue(""), MergableProperty(false)]
        public string Name
        {
            get
            {
