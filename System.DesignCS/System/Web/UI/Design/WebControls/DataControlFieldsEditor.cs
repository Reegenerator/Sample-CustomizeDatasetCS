namespace System.Web.UI.Design.WebControls
{
    ...
    internal sealed class DataControlFieldsEditor : DesignerForm
    {
        ...
        {
            System.Drawing.Image image = System.Drawing.BitmapSelector.CreateBitmap(base.GetType(), "FieldNodes.bmp");
            ...
            Bitmap bitmap = System.Drawing.BitmapSelector.CreateIcon(base.GetType(), "SortUp.ico").ToBitmap();
            ...
            Bitmap bitmap2 = System.Drawing.BitmapSelector.CreateIcon(base.GetType(), "SortDown.ico").ToBitmap();
            ...
            Bitmap bitmap3 = System.Drawing.BitmapSelector.CreateIcon(base.GetType(), "Delete.ico").ToBitmap();
            ...
            base.Icon = System.Drawing.BitmapSelector.CreateIcon(base.GetType(), "DataControlFieldsEditor.ico");
        }
        ...
        private class DataFieldNode : DataControlFieldsEditor.AvailableFieldNode
        {
            ...
            public override DataControlFieldsEditor.FieldItem[] CreateFields(DataBoundControl control, IDataSourceFieldSchema[] fieldSchemas)
            {
                ...
                foreach (IDataSourceFieldSchema schema in fieldSchemas)
                {
                    if (DataBinder.IsBindableType(schema.DataType))
                    {
