namespace System.Web.UI.Design.WebControls
{
    ...
    public class SqlDataSourceDesigner : DataSourceDesigner
    {
        ...
        [TypeConverter(typeof(SqlDataSourceQueryConverter)), Category("Data"), DefaultValue(0), System.Design.SRDescription("SqlDataSourceDesigner_DeleteQuery"), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), Editor(typeof(SqlDataSourceQueryEditor), typeof(UITypeEditor)), MergableProperty(false)]
        ...
        [DefaultValue(1), Category("Data"), TypeConverter(typeof(SqlDataSourceQueryConverter)), System.Design.SRDescription("SqlDataSourceDesigner_InsertQuery"), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), Editor(typeof(SqlDataSourceQueryEditor), typeof(UITypeEditor)), MergableProperty(false)]
        ...
        [Category("Data"), TypeConverter(typeof(SqlDataSourceQueryConverter)), DefaultValue(2), System.Design.SRDescription("SqlDataSourceDesigner_SelectQuery"), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), Editor(typeof(SqlDataSourceQueryEditor), typeof(UITypeEditor)), MergableProperty(false)]
        ...
        [MergableProperty(false), TypeConverter(typeof(SqlDataSourceQueryConverter)), Category("Data"), DefaultValue(3), System.Design.SRDescription("SqlDataSourceDesigner_UpdateQuery"), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), Editor(typeof(SqlDataSourceQueryEditor), typeof(UITypeEditor))]
