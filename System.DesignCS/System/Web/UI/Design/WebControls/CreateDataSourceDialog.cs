namespace System.Web.UI.Design.WebControls
{
    ...
    internal sealed class CreateDataSourceDialog : TaskForm
    {
        ...
        public CreateDataSourceDialog(ControlDesigner controlDesigner, System.Type dataSourceType, bool configure) : base(controlDesigner.Component.Site)
        {
            ...
            base.Glyph = System.Drawing.BitmapSelector.CreateBitmap(base.GetType(), "datasourcewizard.bmp");
            this.CreatePanel();
        }
            ...
            if (site != null)
            {
                ...
                if (service != null)
                {
                    ...
                    if (componentTypes != null)
                    {
                        ...
                        this.IsTargetFramework45OrAbove();
                        ...
                        foreach (System.Type type in array)
                        {
                            if (this.IsSupportedInTargetFramework(type))
                            {
                                ...
                                if (image == null)
                                {
                                    image = System.Drawing.BitmapSelector.CreateBitmap(base.GetType(), "CustomDataSource.bmp");
                                }
        ...
        private bool IsSupportedInTargetFramework(System.Type type)
        {
            if (type == typeof(AccessDataSource))
            {
                return !this.IsTargetFramework45OrAbove();
            }
            return true;
        }
        ...
        private System.ComponentModel.TypeDescriptionProvider TypeDescriptionProvider
        {
            get
            {
                System.Web.UI.Control component = this._controlDesigner.Component as System.Web.UI.Control;
                if (component != null)
                {
                    return TypeDescriptor.GetProvider(component);
                }
                return null;
            }
        }
