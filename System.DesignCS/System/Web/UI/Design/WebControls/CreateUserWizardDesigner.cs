        ...
        public override DesignerAutoFormatCollection AutoFormats
        {
            get
            {
                if (_autoFormats == null)
                {
                    ...
                    {
                        CS9__CachedAnonymousMethodDelegate3 = new Func<string, DesignerAutoFormat>(null, (IntPtr) <get_AutoFormats>b__2);
                    }
                    _autoFormats = ControlDesigner.CreateAutoFormats(AutoFormatSchemes.CREATEUSERWIZARD_SCHEME_NAMES, CS9__CachedAnonymousMethodDelegate3);
                }
                return _autoFormats;
            }
        }
