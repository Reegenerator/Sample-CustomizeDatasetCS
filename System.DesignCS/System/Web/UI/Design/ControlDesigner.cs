namespace System.Web.UI.Design
{
    ...
    public class ControlDesigner : HtmlControlDesigner
    {
        ...
        internal static DesignerAutoFormatCollection CreateAutoFormats(string[] schemeNames, Func<string, DesignerAutoFormat> creationDelegate)
        {
            ...
            {
                formats.Add(creationDelegate.Invoke(str));
            }
            return formats;
        }
        ...
        [Obsolete("The recommended alternative is GetPersistenceContent(). http://go.microsoft.com/fwlink/?linkid=14202"), TargetedPatchingOptOut("Performance critical to inline this type of method across NGen image boundaries")]
        ...
        [Obsolete("Use of this method is not recommended because resizing is handled by the OnComponentChanged() method. http://go.microsoft.com/fwlink/?linkid=14202"), TargetedPatchingOptOut("Performance critical to inline this type of method across NGen image boundaries")]
