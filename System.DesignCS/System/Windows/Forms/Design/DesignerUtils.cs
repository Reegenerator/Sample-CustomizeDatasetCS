namespace System.Windows.Forms.Design
{
    ...
    internal static class DesignerUtils
    {
        ...
        static DesignerUtils()
        {
            ...
            {
                BOXIMAGESIZE = System.Windows.Forms.DpiHelper.LogicalToDeviceUnitsX(BOXIMAGESIZE);
                SELECTIONBORDERSIZE = System.Windows.Forms.DpiHelper.LogicalToDeviceUnitsX(SELECTIONBORDERSIZE);
                SELECTIONBORDERHITAREA = System.Windows.Forms.DpiHelper.LogicalToDeviceUnitsX(SELECTIONBORDERHITAREA);
                HANDLESIZE = System.Windows.Forms.DpiHelper.LogicalToDeviceUnitsX(HANDLESIZE);
                HANDLEOVERLAP = System.Windows.Forms.DpiHelper.LogicalToDeviceUnitsX(HANDLEOVERLAP);
                NORESIZEHANDLESIZE = System.Windows.Forms.DpiHelper.LogicalToDeviceUnitsX(NORESIZEHANDLESIZE);
                LOCKHANDLEHEIGHT = System.Windows.Forms.DpiHelper.LogicalToDeviceUnitsY(LOCKHANDLEHEIGHT);
                LOCKHANDLEWIDTH = System.Windows.Forms.DpiHelper.LogicalToDeviceUnitsX(LOCKHANDLEWIDTH);
                LOCKHANDLEOVERLAP = System.Windows.Forms.DpiHelper.LogicalToDeviceUnitsX(LOCKHANDLEOVERLAP);
                LOCKHANDLESIZE_UPPER = System.Windows.Forms.DpiHelper.LogicalToDeviceUnitsX(LOCKHANDLESIZE_UPPER);
                LOCKHANDLEHEIGHT_LOWER = System.Windows.Forms.DpiHelper.LogicalToDeviceUnitsY(LOCKHANDLEHEIGHT_LOWER);
                LOCKHANDLEWIDTH_LOWER = System.Windows.Forms.DpiHelper.LogicalToDeviceUnitsX(LOCKHANDLEWIDTH_LOWER);
                CONTAINERGRABHANDLESIZE = System.Windows.Forms.DpiHelper.LogicalToDeviceUnitsX(CONTAINERGRABHANDLESIZE);
                RESIZEGLYPHSIZE = System.Windows.Forms.DpiHelper.LogicalToDeviceUnitsX(RESIZEGLYPHSIZE);
