    ...
    internal class ToolStripMenuItemDesigner : ToolStripDropDownItemDesigner
    {
        ...
        internal void InitializeDropDown()
        {
            ...
            if (!this.initialized)
            {
                ...
                if (service != null)
                {
                    service.Invalidate(this.MenuItem.Owner.Bounds);
                }
            }
        }
        ...
        internal void ShowOwnerDropDown(ToolStripDropDownItem currentSelection)
        {
            ...
            {
                ToolStripDropDown owner = (ToolStripDropDown) currentSelection.Owner;
                currentSelection = (ToolStripDropDownItem) owner.OwnerItem;
                ...
                else if ((owner is ContextMenuStrip) && !owner.Visible)
                {
                    ToolStripDropDownDesigner designer2 = (ToolStripDropDownDesigner) this.designerHost.GetDesigner(owner);
                    if (designer2 != null)
                    {
                        designer2.ShowMenu(null);
                    }
                }
            }
        }
