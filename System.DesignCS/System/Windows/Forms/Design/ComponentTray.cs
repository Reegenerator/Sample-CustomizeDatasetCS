namespace System.Windows.Forms.Design
{
    ...
    [ProvideProperty("TrayLocation", typeof(IComponent)), ToolboxItem(false), DesignTimeVisible(false), ProvideProperty("Location", typeof(IComponent))]
    public class ComponentTray : ScrollableControl, IExtenderProvider, ISelectionUIHandler, IOleDragClient
    {
        ...
        [DesignOnly(true), Category("Layout"), Localizable(false), Browsable(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), System.Design.SRDescription("ControlLocationDescr")]
        ...
        [Localizable(false), Category("Layout"), Browsable(false), System.Design.SRDescription("ControlLocationDescr"), DesignOnly(true)]
        ...
        protected override void OnPaint(PaintEventArgs pe)
        {
            if (this.fResetAmbient)
            {
                ...
                {
                    System.Drawing.Color info;
                    if (service.Styles["ArtboardBackground"] is System.Drawing.Color)
                    {
                        info = (System.Drawing.Color) service.Styles["ArtboardBackground"];
                    }
                    else if (service.Styles["VsColorDesignerTray"] is System.Drawing.Color)
                    {
