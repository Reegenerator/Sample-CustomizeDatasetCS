    ...
    internal class ToolStripItemDesigner : ComponentDesigner
    {
        ...
        private void OnSelectionChanged(object sender, EventArgs e)
        {
            ...
            if (service != null)
            {
                ...
                if (((primarySelection != null) && primarySelection.Equals(this.ToolStripItem)) && !(this.ToolStripItem is ToolStripMenuItem))
                {
                    if (primarySelection.IsOnDropDown)
                    {
                        ...
                        if (host != null)
                        {
                            ...
                            if (owner != null)
                            {
                                ...
                                else if (owner is ContextMenuStrip)
                                {
                                    ToolStripDropDownDesigner designer2 = (ToolStripDropDownDesigner) host.GetDesigner(owner);
                                    if (designer2 != null)
                                    {
                                        designer2.ShowMenu(primarySelection);
                                    }
                                    flag = true;
                                }
                                if (flag)
                                {
                                    ...
                                    if (service2 != null)
                                    {
                                        service2.Invalidate(owner.Bounds);
                                    }
                                }
                            }
                        }
                    }
                    else if (primarySelection.Owner != null)
                    {
                        BehaviorService service3 = (BehaviorService) this.GetService(typeof(BehaviorService));
                        if (service3 != null)
                        {
                            service3.Invalidate(service3.ControlRectInAdornerWindow(primarySelection.Owner));
                        }
                    }
                }
            }
