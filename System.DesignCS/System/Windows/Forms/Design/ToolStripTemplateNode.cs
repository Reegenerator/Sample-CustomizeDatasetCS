namespace System.Windows.Forms.Design
{
    ...
    internal class ToolStripTemplateNode : IMenuStatusHandler
    {
        ...
        private static int TEMPLATE_HEIGHT = 0x13;
        private const int TEMPLATE_HEIGHT_ORIGINAL = 0x13;
        private static int TEMPLATE_HOTREGION_WIDTH = 9;
        private const int TEMPLATE_HOTREGION_WIDTH_ORIGINAL = 9;
        private static int TEMPLATE_WIDTH = 0x1f;
        private const int TEMPLATE_WIDTH_ORIGINAL = 0x1f;
        private static int TOOLSTRIP_TEMPLATE_HEIGHT = 0x16;
        private const int TOOLSTRIP_TEMPLATE_HEIGHT_ORIGINAL = 0x16;
        private static int TOOLSTRIP_TEMPLATE_WIDTH = 0x5c;
        private const int TOOLSTRIP_TEMPLATE_WIDTH_ORIGINAL = 0x5c;
