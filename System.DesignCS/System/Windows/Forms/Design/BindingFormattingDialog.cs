    ...
    internal class BindingFormattingDialog : Form
    {
        ...
        private static Bitmap BoundBitmap
        {
            get
            {
                if (boundBitmap == null)
                {
                    boundBitmap = new Bitmap(System.Drawing.BitmapSelector.GetResourceStream(typeof(BindingFormattingDialog), "BindingFormattingDialog.Bound.bmp"));
        ...
        private static Bitmap UnboundBitmap
        {
            get
            {
                ...
                {
                    unboundBitmap = new Bitmap(System.Drawing.BitmapSelector.GetResourceStream(typeof(BindingFormattingDialog), "BindingFormattingDialog.Unbound.bmp"));
