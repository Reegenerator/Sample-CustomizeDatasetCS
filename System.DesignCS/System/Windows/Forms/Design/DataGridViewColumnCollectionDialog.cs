    ...
    internal class DataGridViewColumnCollectionDialog : Form
    {
        ...
        private Bitmap SelectedColumnsItemBitmap
        {
            get
            {
                ...
                {
                    selectedColumnsItemBitmap = new Bitmap(System.Drawing.BitmapSelector.GetResourceStream(typeof(DataGridViewColumnCollectionDialog), "DataGridViewColumnsDialog.selectedColumns.bmp"));
