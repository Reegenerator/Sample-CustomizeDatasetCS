    ...
    internal class ToolStripItemCustomMenuItemCollection : CustomMenuItemCollection
    {
        ...
        private ToolStripMenuItem CreatePropertyBasedItem(string text, string propertyName, string imageName)
        {
            ...
            if (flag)
            {
                ...
                {
                    item.Image = new Bitmap(System.Drawing.BitmapSelector.GetResourceStream(typeof(ToolStripMenuItem), imageName));
            ...
            if (this.currentItem is ToolStripDropDownItem)
            {
                ...
                if (service != null)
                {
                    ...
                    if (designer != null)
                    {
                        ...
                        this.editItemsToolStripMenuItem.Image = new Bitmap(System.Drawing.BitmapSelector.GetResourceStream(typeof(ToolStripMenuItem), "editdropdownlist.bmp"));
