namespace System.Windows.Forms.Design
{
    ...
    internal class TableLayoutPanelDesigner : FlowPanelDesigner
    {
        ...
        {
            bool isRow = ((DesignerVerb) sender).Text.Equals(this.ReplaceText(System.Design.SR.GetString("TableLayoutPanelDesignerAddRow")));
            this.OnAdd(isRow);
        }
        ...
        {
            bool isRow = ((DesignerVerb) sender).Text.Equals(this.ReplaceText(System.Design.SR.GetString("TableLayoutPanelDesignerRemoveRow")));
            this.OnRemove(isRow);
        }
        ...
        [DesignerSerializer(typeof(TableLayoutPanelDesigner.DesignerTableLayoutControlCollectionCodeDomSerializer), typeof(CodeDomSerializer)), ListBindable(false)]
