    ...
    internal class InheritanceUI
    {
        ...
        public Bitmap InheritanceGlyph
        {
            get
            {
                ...
                {
                    inheritanceGlyph = new Bitmap(System.Drawing.BitmapSelector.GetResourceStream(typeof(InheritanceUI), "InheritedGlyph.bmp"));
                    inheritanceGlyph.MakeTransparent();
                    if (System.Windows.Forms.DpiHelper.IsScalingRequired)
                    {
                        System.Windows.Forms.DpiHelper.ScaleBitmapLogicalToDevice(ref inheritanceGlyph);
                    }
                }
