        ...
        private Image GlyphImageClosed
        {
            get
            {
                if (this.glyphImageClosed == null)
                {
                    ...
                    {
                        System.Windows.Forms.DpiHelper.ScaleBitmapLogicalToDevice(ref this.glyphImageClosed);
                    }
                }
        ...
        private Image GlyphImageOpened
        {
            get
            {
                if (this.glyphImageOpened == null)
                {
                    ...
                    if (System.Windows.Forms.DpiHelper.IsScalingRequired)
                    {
                        System.Windows.Forms.DpiHelper.ScaleBitmapLogicalToDevice(ref this.glyphImageOpened);
                    }
                }
