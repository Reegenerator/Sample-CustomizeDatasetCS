    ...
    internal class BaseContextMenuStrip : GroupedContextMenuStrip
    {
        ...
        private void InitializeContextMenu()
        {
            ...
            if (service != null)
            {
                ...
                if (service.Styles["VsColorPanelText"] is Color)
                {
                    base.ForeColor = (Color) service.Styles["VsColorPanelText"];
                }
            }
        ...
        private void RefreshSelectionMenuItem()
        {
            ...
            if (count > 0)
            {
                ...
                if (service2 != null)
                {
                    ...
                    if (service2.Styles["VsColorPanelText"] is Color)
                    {
                        this.selectionMenuItem.DropDown.ForeColor = (Color) service2.Styles["VsColorPanelText"];
                    }
                }
