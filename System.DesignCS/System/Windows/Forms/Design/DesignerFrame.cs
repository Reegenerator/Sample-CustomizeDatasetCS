namespace System.Windows.Forms.Design
{
    ...
    internal class DesignerFrame : Control, IOverlayService, ISplitWindowService, IContainsThemedScrollbarWindows
    {
        ...
        IEnumerable IContainsThemedScrollbarWindows.ThemedScrollbarWindows()
        {
            ...
            {
                ThemedScrollbarWindow window = new ThemedScrollbarWindow {
                    Handle = control.Handle
                };
                if (control is OverlayControl)
                {
                    window.Mode = ThemedScrollbarMode.OnlyTopLevel;
                }
                else
                {
                    window.Mode = ThemedScrollbarMode.All;
                }
                list.Add(window);
            }
            return list;
        ...
        void ISplitWindowService.AddSplitWindow(Control window)
        {
            if (this.splitter == null)
            {
                ...
                if ((this.uiService != null) && (this.uiService.Styles["HorizontalResizeGrip"] is System.Drawing.Color))
                {
                    this.splitter.BackColor = (System.Drawing.Color) this.uiService.Styles["HorizontalResizeGrip"];
                }
                else
                {
