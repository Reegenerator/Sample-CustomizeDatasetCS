namespace System.ComponentModel.Design.Serialization
{
    ...
    [SecurityCritical, PermissionSet(SecurityAction.InheritanceDemand, Name="FullTrust")]
    public abstract class CodeDomDesignerLoader : BasicDesignerLoader, INameCreationService, IDesignerSerializationService
    {
        ...
        [ProvideProperty("Modifiers", typeof(IComponent)), ProvideProperty("GenerateMember", typeof(IComponent))]
        private class ModifiersExtenderProvider : IExtenderProvider
        {
            ...
            [HelpKeyword("Designer_GenerateMember"), Category("Design"), DefaultValue(true), DesignOnly(true), System.Design.SRDescription("CodeDomDesignerLoaderPropGenerateMember")]
            ...
            [System.Design.SRDescription("CodeDomDesignerLoaderPropModifiers"), DefaultValue(0x5000), DesignOnly(true), TypeConverter(typeof(CodeDomDesignerLoader.ModifierConverter)), Category("Design"), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), HelpKeyword("Designer_Modifiers")]
        ...
        private class ModifiersInheritedExtenderProvider : IExtenderProvider
        {
            ...
            [DesignOnly(true), TypeConverter(typeof(CodeDomDesignerLoader.ModifierConverter)), Category("Design"), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), System.Design.SRDescription("CodeDomDesignerLoaderPropModifiers"), DefaultValue(0x5000)]
            public MemberAttributes GetModifiers(IComponent comp)
            {
