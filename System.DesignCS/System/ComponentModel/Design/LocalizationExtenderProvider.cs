namespace System.ComponentModel.Design
{
    ...
    [Obsolete("This class has been deprecated. Use CodeDomLocalizationProvider instead.  http://go.microsoft.com/fwlink/?linkid=14202"), ProvideProperty("Language", typeof(object)), ProvideProperty("Localizable", typeof(object)), ProvideProperty("LoadLanguage", typeof(object))]
    public class LocalizationExtenderProvider : IExtenderProvider, IDisposable
    {
        ...
        [System.Design.SRDescription("ParentControlDesignerLanguageDescr"), Localizable(true), DesignOnly(true)]
        public CultureInfo GetLanguage(object o)
        {
            return this.language;
        }

        [DesignOnly(true), Browsable(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        ...
        [System.Design.SRDescription("ParentControlDesignerLocalizableDescr"), Localizable(true), DesignOnly(true)]
