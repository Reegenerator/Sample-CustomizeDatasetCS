...
// Generation date: 2014-01-31 10:12
...
namespace DatasetRenderer.Dataset
{
    ...
    public partial class DataSetWithManagerRenderer : Kodeo.Reegenerator.Generators.CodeRenderer
    {
 ...
 foreach (System.Data.DataRelation relation in this._dataSet.Relations) { 
            ...
            this.Output.Write( relation.RelationName.ToIdentifier() );
            this.Output.Write(";\r\n");
 } 
            this.Output.Write("        \r\n        private global::System.Data.SchemaSerializationMode _schemaSeri" +
                    "alizationMode = global::System.Data.SchemaSerializationMode.IncludeSchema;\r\n    " +
                    "    \r\n\t\t");
...
");
 foreach (System.Data.DataTable table in this._dataSet.Tables) { 
		...
		static private ");
            this.Output.Write(this._dataSet.DataSetName );
            this.Output.Write("TableAdapters.TableAdapterManager adapterManager;\r\n        static public ");
            this.Output.Write(this._dataSet.DataSetName );
            this.Output.Write("TableAdapters.TableAdapterManager AdapterManager\r\n\t\t{\r\n\t\t\tget\r\n\t\t\t{\r\n            " +
                    "    if (adapterManager == null) adapterManager = new ");
            this.Output.Write(this._dataSet.DataSetName );
            this.Output.Write("TableAdapters.TableAdapterManager();\r\n\t\t\t\treturn adapterManager;\r\n\t\t\t}\r\n\t\t}\r\n\t\t");
 foreach (System.Data.DataTable table in this._dataSet.Tables) { 
            this.Output.Write("\r\n        static public ");
            this.Output.Write(TableClassName(table) );
            ...
            this.Output.Write("()\r\n        {\r\n\t\t\tif (AdapterManager.");
            this.Output.Write(TablePropName(table) );
            this.Output.Write("TableAdapter == null) AdapterManager.");
            this.Output.Write(TablePropName(table) );
            this.Output.Write("TableAdapter = new ");
            this.Output.Write(this._dataSet.DataSetName );
            this.Output.Write("TableAdapters.");
            this.Output.Write(TablePropName(table) );
            this.Output.Write("TableAdapter();\r\n            return AdapterManager.");
            this.Output.Write(TablePropName(table) );
            this.Output.Write("TableAdapter.GetData();\r\n        }\r\n\t\t");
} 
            this.Output.Write("\r\n");
 foreach (System.Data.DataTable table in this._dataSet.Tables) { 
            this.Output.Write("\r\n        ");
...
");
 ...
 foreach (System.Data.DataTable table in this._dataSet.Tables) { 
        ...
        foreach (System.Data.DataTable table in this._dataSet.Tables)
            ...
            this.Output.Write("        \r\n   }\r\n}\r\n\r\n");
            this.Output.Write( RenderTableAdapters() );
